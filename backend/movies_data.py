# Hardcoded real movie data with TMDB poster paths
MOVIES = [
    {
        "movie_id": 1,
    ...
    },
    {
        ...
        "rating": 9.2,
        "sources": ["Paramount+", "Amazon Prime"],
    ...
    },
    {
        ...
        "plot": "In a post-apocalyptic wasteland, Max teams up with a mysterious woman, Furiousa, to try and escape from a tyrannical warlord.",
        "rating": 8.1,
        "sources": ["Netflix", "HBO Max"],
    ...
    },
    {
        ...
        "rating": 8.1,
        "sources": ["Netflix", "Amazon Prime"],
        "poster_path": "/63viWuPfYQjRYLSZSZNq7dglJP5.jpg"
    },
    {
        "movie_id": 50,
...
def get_movie(movie_id: int):
    """Get movie by ID, returns None if not found"""
    for m in MOVIES:
